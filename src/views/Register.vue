...
import { getUserInfo, getSmsCaptcha, register } from "@/config/service/user";
...
export default class extends Vue {
  ...
  private async handleGetSmsCaptcha() {
    let { mobile, captcha } = this.registerForm;
